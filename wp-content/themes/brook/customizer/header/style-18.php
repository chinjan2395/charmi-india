...
Brook_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		...
		array(
			'element'  => '.header-18 .wpml-ls-slot-shortcode_actions:hover > .js-wpml-ls-item-toggle',
			'property' => 'color',
			'suffix'   => '!important',
		),
		array(
			'element'  => '.header-18 .header-social-networks a:hover',
...
Brook_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => esc_html__( 'Hire Us Now', 'brook' ),
) );
