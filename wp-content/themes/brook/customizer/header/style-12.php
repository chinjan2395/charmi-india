...
Brook_Kirki::add_field( 'theme', array(
	...
	'label'     => esc_html__( 'Header Padding', 'brook' ),
	'section'   => $section,
	'priority'  => $priority++,
	'default'   => array(
		'top'    => '24px',
...
Brook_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		...
		array(
			'element'  => '.header-12 .wpml-ls-slot-shortcode_actions:hover > .js-wpml-ls-item-toggle',
			'property' => 'color',
			'suffix'   => '!important',
		),
	),
...
Brook_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-12 .mini-cart .mini-cart-icon:after',
