...
if ( ! class_exists( 'Brook_VC_Icon_Linea' ) ) {
	class Brook_VC_Icon_Linea {
		...
		public function add_to_libraries( $list ) {
			$list = $list + array( esc_html__( 'Linea', 'brook' ) => 'linea' );
		...
		public function vc_element_enqueue( $font ) {
			switch ( $font ) {
				case 'linea':
					wp_enqueue_style( 'font-linea', BROOK_THEME_URI . '/assets/fonts/linea/font-linea.min.css', null, null );
					break;
			}
		}
